...
freeVarsSpec = describe "freeVars" do
  ...
  it "works with sum" do
    freeVars (Sum "i" (Var "x") (If (Var "i") (Var "y") (Var "z"))) `shouldMatchList`
      ["x", "y", "z"]
  it "works with the sum variable in the limit expression" do
    freeVars (Sum "i" (Var "i") (If (Var "i") (Var "y") (Var "z"))) `shouldMatchList`
      ["i", "y", "z"]
...
partialEvalSpec = pdescribe "partialEval" do
  ...
  modifyMaxSuccess (\_ -> 200000) $ modifyMaxSize (\_ -> 8) $
